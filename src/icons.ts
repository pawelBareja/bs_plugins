...
export const ICON_LIBRARY: Record< string, IconDef > = {
	...
	shoppingCart: {
		label: 'Koszyk',
		svg: toSvg( ShoppingCart ),
		Component: ShoppingCart,
	},
	shoppingBag: {
		label: 'Torba zakupowa',
		svg: toSvg( ShoppingBag ),
	...
	arrowRight: {
		...
		svg: toSvg( ArrowRight ),
		Component: ArrowRight,
	},
	arrowSquareUp: {
		label: 'Eksport / wgórę',
		svg: toSvg( ArrowSquareUp ),
		Component: ArrowSquareUp,
	},
	paperPlaneTilt: {
		label: 'Wyślij',
		svg: toSvg( PaperPlaneTilt ),
